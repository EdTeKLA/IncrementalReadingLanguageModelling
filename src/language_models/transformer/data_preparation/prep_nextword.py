...
train_loc = '../../../../data/wiki/sequences/word/wiki_train_word.txt'

preproc_train_loc = '../../../../data/wiki/sequences/word/transformer/wiki_train_word.txt'

emb_dict_loc = '../../../../data/wiki/sequences/word/transformer/wiki_train_word_indices'

freq_dict_loc = '../../../../data/wiki/sequences/word/transformer/wiki_train_word_freq'

preprocess(train_loc, preproc_train_loc, emb_dict_loc, freq_dict_loc)


# location of the validation database
train_loc = '../../../../data/wiki/sequences/word/wiki_validation_word.txt'

preproc_train_loc = '../../../../data/wiki/sequences/word/transformer/wiki_validation_word.txt'

emb_dict_loc = '../../../../data/wiki/sequences/word/transformer/wiki_train_validation_indices'

freq_dict_loc = '../../../../data/wiki/sequences/word/transformer/wiki_train_validation_freq'
