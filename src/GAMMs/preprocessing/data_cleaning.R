...
data$RNNG_surp_wins = Winsorize(data$RNNG_surp, probs=c(0.05, 0.95))
...
data$n_gram_word_POS_surp_winsPrev1 = data$n_gram_word_POS_surp_wins
...
write.csv(data, "../../../output/GAMMs/all_data_cleaned.csv", row.names=FALSE)
