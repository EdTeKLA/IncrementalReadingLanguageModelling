    ...
    do
      ...
      do
        ...
        do
          ...
          MODEL_PATH="IncrementalReadingLanguageModelling/src/RNNG/rnng-pytorch/"$MODEL"_wiki_pos.pt"
          SURPRISAL_PATH="surprisals_validation_pos_"$MODEL".txt"
          TREE_PATH="trees_validation_pos_"$MODEL".parsed"
